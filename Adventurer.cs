namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        {
            return $"{Name} is wearing a robe that is {ColorfulRobe.Length} inches and colors {string.Join(", ", ColorfulRobe.Colors)} with a {Hat.ShininessDescription} hat on the dome.";
        }
    }
}